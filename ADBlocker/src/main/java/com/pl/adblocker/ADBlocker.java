...
public class ADBlocker {
	...
	public void startEngine() throws Throwable {
		if (abpEngine == null) {
			...
			basePath.mkdirs();
            Log.d("AdBlockNew", "startEngine start");
			AppInfo appInfo = ABPEngine.generateAppInfo(mApplication);
			Log.d("AdBlockNew", "appinfo is  :"+appInfo.name);
			abpEngine = ABPEngine.create(mApplication,
					appInfo,
					basePath.getAbsolutePath());
			Log.d("AdBlockNew", "abpEngine is  :"+abpEngine.toString());
	...
	private void initAdblockPlus() throws Throwable {
		...
		Log.d("AdBlockNew", "initAdblockPlus");

		if (abpEngine == null) {
			startEngine();
			Log.d("AdBlockNew", "startEngine end");
		...
		Log.d("AdBlockNew", "initAdblockPlus end");
